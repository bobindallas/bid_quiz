...
Route::delete('quiz_questions/destroy/{quiz_question_id}',               'QuizQuestionController@destroy')->name('quiz_questions.destroy');
...
Route::delete('quiz_question_options/destroy/{quiz_question_option_id}', 'QuizQuestionOptionController@destroy')->name('quiz_question_options.destroy');
